...
int main(int argc, char** argv){
  ...
  goal.target_pose.pose.position.x = 1.151;
  goal.target_pose.pose.position.y = 4.328;
  ...
  // Wait 5 sec for move_base action server to come up
  while(!ac.waitForServer(ros::Duration(5.0))){
    ROS_INFO("pausing 5 seconds after reaching pickup zone");
  }
  ...
  goal2.target_pose.pose.orientation.w = 0.010;
